...
<body>
	...
	if (!isset($_SESSION["attempts"])) {
        ...
        <form action="index.php" method="post">
            ...
            <input type="number" required="true" class="form-control text-center" name="response" placeholder="Enter Answer" />
            <button type="submit">Submit Answer</button>
			<button type="button" a href="signout.php">Sign Out</button>
        </form>
        <?php 
